...
def load_txt_data(txt_file):
    ...
    # Ensure the number of lines is even (each user input and bot response pair)
    if total_lines % 2 != 0:
        total_lines -= 1  # Exclude the last line if it's an odd number of lines
...
intents = load_txt_data('conversations.txt')  # Replace 'conversations.txt' with your TXT file name
